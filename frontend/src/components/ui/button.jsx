    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
    {
        variants: {
            variant: {
                ...
                outline: "border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-slate-400 dark:hover:border-slate-500",
                ...
                gradient: "bg-gradient-to-r from-primary-600 via-gold-500 to-emerald-600 text-white hover:shadow-lg hover:scale-105 transition-all duration-300",
                islamic: "bg-gradient-to-r from-emerald-600 to-primary-600 text-white hover:from-emerald-700 hover:to-primary-700 shadow-md hover:shadow-lg"
            },
            size: {
